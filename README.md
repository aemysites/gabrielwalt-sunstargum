...
## Environments
- Preview: https://main--gabrielwalt-sunstargum--aemysites.aem.page/
- Live: https://main--gabrielwalt-sunstargum--aemysites.aem.live/
- Block Library: https://main--gabrielwalt-sunstargum--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `gabrielwalt-sunstargum` directory in your favorite IDE and start coding :)
